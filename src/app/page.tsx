    ...
    <div>
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 sm:py-24 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <a
              ...
              className="border border-gray-400 hover:border-green-600 hover:text-green-700 text-gray-700 font-medium rounded-md px-6 py-3"
            >
              {t.whatsappUs}
            </a>
          </div>
      ...
      <section className="max-w-6xl mx-auto px-4 py-14">
        ...
        <div className="text-center mt-10">
          <Link
            href="/products"
            className="inline-block text-blue-800 font-medium underline underline-offset-4 hover:text-blue-700"
          >
            {t.viewAll} →
          </Link>
        </div>
